...
![](graphs/Maximum%20Temp%20Variation-City.png) <br> Based on the above result, it can be said that top 20 cities based on the Maximum variation in monthly average temperature are having the variation in the range of around 33 to 47. <br> <br> <b>Question 4: Compare the two graphs in (i) and (iii) and comment it.</b>
